# # -*- coding: utf-8 -*-
# """
# Created on Tue Feb 21 10:36:20 2023
...
#     "num_threads": 1, #get_allowed_n_proc_DA() if get_allowed_n_proc_DA() is not None else 12,
...
# default_2D_augmentation_params["mirror_axes"] = (0, 1)  # this can be (0, 1, 2) if dummy_2D=Tru


# tr_transforms = []


# p = "C:/Users/A0067501/Desktop/nnunet/RESULTS_FOLDER/nnUNet/3d_fullres/Task501_Heart/nnUNetTrainerV2__nnUNetPlansv2.1/"
...
# temp="C:/Users/A0067501/Desktop/nnunet/nnUNet_preprocessed/Task501_Heart/nnUNetData_plans_v2.1_stage0/"

# test=np.load(temp+"Case_002.npz")
...
if __name__ == "__main__":
    ...
    import os
    import pickle
    preprocessing_output_dir="C:/Users/A0067501/Desktop/nnunet/nnUNet_preprocessed/"
    t = "Task501_Heart/nnUNetData_plans_v2.1_stage0"
    p = os.path.join(preprocessing_output_dir, t)
    dataset = load_dataset(p, 0)
    with open(os.path.join(preprocessing_output_dir,"Task501_Heart", "nnUNetPlansv2.1_plans_3D.pkl"), 'rb') as f:
        plans = pickle.load(f)
    ...
    basic_patch_size=np.array([7,240,224])
    patch_size=np.array([7,240,224])

    dl = DataLoader3D(dataset, basic_patch_size, patch_size, 1)
