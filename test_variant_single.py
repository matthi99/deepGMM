# -*- coding: utf-8 -*-
"""
Created on Fri Mar 15 10:54:19 2024
...
if lam == 0:
    savefolder = "RESULTS_FOLDER/RESULTS/spatially_variant_GMM/single/"
else:
    savefolder = f"RESULTS_FOLDER/RESULTS/spatially_variant_GMM/single_reg_{lam}/"
...
for file in files:
    ...
    if lam == 0:
        gmm = VariantGMM(n_components=4, tol=0.001, init_params= "random")
    else:
    ...
    if lam == 0:
        ...
        path_net = f"RESULTS_FOLDER/spatially_variant_GMM/single_reg_{lam}/Patient_{patientnr}/weights_{slicenr}.pth"
